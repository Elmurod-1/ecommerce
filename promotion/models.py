...
class Promotion(models.Model):
    ...
    promo_start = models.DateField(auto_now=True)
    promo_end = models.DateField(auto_now=True)

    product_on_promotion = models.ManyToManyField(ProductInventory,
                                                  related_name='product_on_promotion',
                                                  through='ProductsOnPromotion')

    promo_type = models.ForeignKey(PromoType, related_name='promotype', on_delete=models.PROTECT)
...
class ProductsOnPromotion(models.Model):
    product_inventory_id = models.ForeignKey(ProductInventory,
