...
"""bu men qilgan django==4.0.3 dagi database"""
...
#     product_type_atribute = models.ManyToManyField('ProductAttribut', related_name='product_type_atribute', through='ProductTypeAtribute')
#
#     def __str__(self):
#         return self.name
#
